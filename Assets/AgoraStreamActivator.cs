...
public class AgoraStreamActivator : MonoBehaviour
{
    BeemScript beemScript;
    ...
    public IRtcEngine GetEngine { get => mRtcEngine; }
    ...
    public void join(string channel) {
        ...
        mRtcEngine.OnRemoteVideoStateChanged = HandleRemoteVideoToggled;
    ...
    public void HandleRemoteVideoToggled(uint uid, REMOTE_VIDEO_STATE state, REMOTE_VIDEO_STATE_REASON reason, int elapsed) {
        if (state == REMOTE_VIDEO_STATE.REMOTE_VIDEO_STATE_STOPPED) {
            beemScript.ToggleVideoQuad(uid.ToString(), false);
        } else if (state == REMOTE_VIDEO_STATE.REMOTE_VIDEO_STATE_STARTING) {
            beemScript.ToggleVideoQuad(uid.ToString(), true);
        }
    }
    ...
    private void onUserJoined(uint uid, int elapsed) {
        ...
        VideoSurface videoSurface = makePlaneSurface(uid.ToString());//makeImageSurface(uid.ToString());
    ...
    public VideoSurface makePlaneSurface(string goName) {
        //GameObject go = GameObject.Find("LiveQuad"); //GameObject.CreatePrimitive(PrimitiveType.Plane);
        ...
        //return videoSurface;
        if (beemScript == null) {
            beemScript = GameObject.FindObjectOfType<BeemScript>();
        }
        return beemScript.CreateStreamQuad(goName);
    }
    ...
    private void onUserOffline(uint uid, USER_OFFLINE_REASON reason) {
        ...
        beemScript.DeleteQuad(uid.ToString());
    }
